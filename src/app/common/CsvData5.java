...
public class CsvData5 {
	...
	public Boolean save(String city) throws IOException {
		...
		// If no .csv file if found, it is created.
		...
		FileWriter fw = new FileWriter(System.getProperty("user.home") + File.separator + "Cn2Prediction" + File.separator + "pred_id" + city + "5.csv",true);
	...
	public Boolean lastDtMatch(String city) throws IOException {
		...
		File f = new File(System.getProperty("user.home") + File.separator + "Cn2Prediction" + File.separator + "pred_id" + city +"5.csv");
		if(f.isFile()) {
			BufferedReader csvReader = new BufferedReader(new FileReader(System.getProperty("user.home") + File.separator + "Cn2Prediction" + File.separator + "pred_id" + city + "5.csv"));
			String row;
			String[] data = null;
